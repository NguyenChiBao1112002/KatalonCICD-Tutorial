...
WebUI.selectOptionByValue(findTestObject('Object Repository/TestOpsIntegration/Page_CURA Healthcare Service/select_Tokyo CURA Healthcare Center        _5b4107'), 
    'Hongkong CURA Healthcare Center', true)

WebUI.click(findTestObject('Object Repository/TestOpsIntegration/Page_CURA Healthcare Service/div_Visit Date (Required)_input-group-addon'))

WebUI.click(findTestObject('Object Repository/TestOpsIntegration/Page_CURA Healthcare Service/td_10'))

WebUI.setText(findTestObject('Object Repository/TestOpsIntegration/Page_CURA Healthcare Service/textarea_Comment_comment'), 
    'Appointment for HongKong')
